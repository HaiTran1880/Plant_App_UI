...
import TemrModal from '../components/Modal';
...
const Welcome = ({navigation}) => {
  ...
  const [openTemr, setOpenTemrModal] = useState(false);
  const closeModal = () => {
    setOpenTemrModal(false);
  };
  return (
    <SafeAreaView style={styles.container}>
      <TemrModal isOpen={openTemr} onClose={closeModal} />
      ...
      <View style={styles.bottom}>
        ...
        <TouchableOpacity onPress={() => setOpenTemrModal(true)}>

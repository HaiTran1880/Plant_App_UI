      ...
      <View style={styles.TabBar}>
        <View style={styles.containTabBar}>
          <TouchableOpacity
            ...
            <Text
              style={
                tabSelected == 0 ? styles.textActived : styles.textInActived
              }>
              Products
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            ...
            <Text
              style={
                tabSelected == 1 ? styles.textActived : styles.textInActived
              }>
              Inspirations
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            ...
            <Text
              style={
                tabSelected == 2 ? styles.textActived : styles.textInActived
              }>
              Shop
            </Text>
          </TouchableOpacity>
